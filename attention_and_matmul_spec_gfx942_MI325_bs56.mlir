...
//===----------------------------------------------------------------------===//
// Punet Batch Size 56 Contraction and Matmul Tuning
//===----------------------------------------------------------------------===//

  transform.named_sequence @match_contraction_112x4096x1920_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x1920x4096xi8>, %arg2: tensor<640x1920xi8>, %arg3: tensor<112x4096x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x1920x4096xi8>, tensor<640x1920xi8>) outs(%arg3 : tensor<112x4096x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x32x32_1280_5760_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x34x34x640xi8>, %arg2: tensor<1280x3x3x640xi8>, %arg3: tensor<112x32x32x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x34x34x640xi8>, tensor<1280x3x3x640xi8>) outs(%arg3 : tensor<112x32x32x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_contraction_112x1024x2560_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x2560x1024xi8>, %arg2: tensor<1280x2560xi8>, %arg3: tensor<112x1024x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x2560x1024xi8>, tensor<1280x2560xi8>) outs(%arg3 : tensor<112x1024x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_contraction_112x16384x960_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x960x16384xi8>, %arg2: tensor<320x960xi8>, %arg3: tensor<112x16384x320xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x960x16384xi8>, tensor<320x960xi8>) outs(%arg3 : tensor<112x16384x320xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
        %5 = arith.addi %out, %4 : i32
        linalg.yield %5 : i32
      } -> tensor<112x16384x320xi32>
    } : (!transform.any_op) -> (!transform.any_value, !transform.any_value)
    %0 = transform.param.constant #iree_codegen.compilation_info<lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_I32_32x32x16_I8>, promote_operands = [0, 1], reduction = [0, 0, 0, 4], subgroup = [1, 1, 10, 0], subgroup_m_count = 4 : i64, subgroup_n_count = 1 : i64, workgroup = [1, 128, 320, 0]}>, translation_info = <pipeline = LLVMGPUTileAndFuse workgroup_size = [256, 1, 1] subgroup_size = 64, {gpu_pipeline_options = #iree_gpu.pipeline_options<prefetch_shared_memory = true, no_reduce_shared_memory_bank_conflicts = false>, llvm_func_attrs = {"amdgpu-waves-per-eu" = "2"}}>> -> !transform.any_param
    transform.yield %arg0, %0 : !transform.any_op, !transform.any_param
  }
  transform.named_sequence @match_contraction_112x20x64_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x64x2048xi8>, %arg2: tensor<20x64x2048xi8>, %arg3: tensor<112x20x64x64xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d2, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d1, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x64x2048xi8>, tensor<20x64x2048xi8>) outs(%arg3 : tensor<112x20x64x64xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x64x64_640_8640_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x66x66x960xi8>, %arg2: tensor<640x3x3x960xi8>, %arg3: tensor<112x64x64x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x66x66x960xi8>, tensor<640x3x3x960xi8>) outs(%arg3 : tensor<112x64x64x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_contraction_112x16384x640_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x640x16384xi8>, %arg2: tensor<320x640xi8>, %arg3: tensor<112x16384x320xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x640x16384xi8>, tensor<320x640xi8>) outs(%arg3 : tensor<112x16384x320xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_112x1280x64_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x64x2048xi8>, %arg2: tensor<1280x2048xi8>, %arg3: tensor<112x1280x64xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x64x2048xi8>, tensor<1280x2048xi8>) outs(%arg3 : tensor<112x1280x64xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x32x32_1280_17280_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x34x34x1920xi8>, %arg2: tensor<1280x3x3x1920xi8>, %arg3: tensor<112x32x32x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x34x34x1920xi8>, tensor<1280x3x3x1920xi8>) outs(%arg3 : tensor<112x32x32x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x64x64_640_11520_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x66x66x1280xi8>, %arg2: tensor<640x3x3x1280xi8>, %arg3: tensor<112x64x64x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x66x66x1280xi8>, tensor<640x3x3x1280xi8>) outs(%arg3 : tensor<112x64x64x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_112x1024x1920_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x1920x1024xi8>, %arg2: tensor<1280x1920xi8>, %arg3: tensor<112x1024x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d3, d1)>, affine_map<(d0, d1, d2, d3) -> (d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x1920x1024xi8>, tensor<1280x1920xi8>) outs(%arg3 : tensor<112x1024x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_contraction_112x640x4096_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x4096x640xi8>, %arg2: tensor<640x640xi8>, %arg3: tensor<112x640x4096xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x4096x640xi8>, tensor<640x640xi8>) outs(%arg3 : tensor<112x640x4096xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_458752x640x2560_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<458752x2560xi8>, %arg2: tensor<640x2560xi8>, %arg3: tensor<458752x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<458752x2560xi8>, tensor<640x2560xi8>) outs(%arg3 : tensor<458752x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x64x64_640_17280_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x66x66x1920xi8>, %arg2: tensor<640x3x3x1920xi8>, %arg3: tensor<112x64x64x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x66x66x1920xi8>, tensor<640x3x3x1920xi8>) outs(%arg3 : tensor<112x64x64x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_generic_112x128x128_320_2880_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x130x130x320xi8>, %arg2: tensor<320x3x3x320xi8>, %arg3: tensor<112x128x128x320xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x130x130x320xi8>, tensor<320x3x3x320xi8>) outs(%arg3 : tensor<112x128x128x320xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32 
  ...
  transform.named_sequence @match_contraction_458752x640x640_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<458752x640xi8>, %arg2: tensor<640x640xi8>, %arg3: tensor<458752x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<458752x640xi8>, tensor<640x640xi8>) outs(%arg3 : tensor<458752x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x128x128_320_8640_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x130x130x960xi8>, %arg2: tensor<320x3x3x960xi8>, %arg3: tensor<112x128x128x320xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x130x130x960xi8>, tensor<320x3x3x960xi8>) outs(%arg3 : tensor<112x128x128x320xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
//
transform.named_sequence @match_generic_112x64x64_640_5760_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x66x66x640xi8>, %arg2: tensor<640x3x3x640xi8>, %arg3: tensor<112x64x64x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x66x66x640xi8>, tensor<640x3x3x640xi8>) outs(%arg3 : tensor<112x64x64x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_contraction_112x10x4096_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x4096x640xi8>, %arg2: tensor<10x64x640xi8>, %arg3: tensor<112x10x4096x64xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d2, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d1, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x4096x640xi8>, tensor<10x64x640xi8>) outs(%arg3 : tensor<112x10x4096x64xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x128x128_640_5760_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x130x130x640xi8>, %arg2: tensor<640x3x3x640xi8>, %arg3: tensor<112x128x128x640xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x130x130x640xi8>, tensor<640x3x3x640xi8>) outs(%arg3 : tensor<112x128x128x640xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
  ...
  transform.named_sequence @match_generic_112x32x32_1280_11520_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x34x34x1280xi8>, %arg2: tensor<1280x3x3x1280xi8>, %arg3: tensor<112x32x32x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x34x34x1280xi8>, tensor<1280x3x3x1280xi8>) outs(%arg3 : tensor<112x32x32x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_generic_112x32x32_1280_23040_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x34x34x2560xi8>, %arg2: tensor<1280x3x3x2560xi8>, %arg3: tensor<112x32x32x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x34x34x2560xi8>, tensor<1280x3x3x2560xi8>) outs(%arg3 : tensor<112x32x32x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_generic_112x64x64_1280_11520_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x66x66x1280xi8>, %arg2: tensor<1280x3x3x1280xi8>, %arg3: tensor<112x64x64x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x66x66x1280xi8>, tensor<1280x3x3x1280xi8>) outs(%arg3 : tensor<112x64x64x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
        %5 = arith.addi %out, %4 : i32
        linalg.yield %5 : i32
      } -> tensor<112x64x64x1280xi32>
    } : (!transform.any_op) -> (!transform.any_value, !transform.any_value) 
    %0 = transform.param.constant #iree_codegen.compilation_info<lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_I32_16x16x32_I8>, promote_operands = [0, 1], reduction = [0, 0, 0, 0, 2], subgroup = [1, 4, 1, 4, 0], subgroup_m_count = 2 : i64, subgroup_n_count = 4 : i64, workgroup = [1, 8, 16, 256, 0]}>, translation_info = <pipeline = LLVMGPUTileAndFuse workgroup_size = [512, 1, 1] subgroup_size = 64, {gpu_pipeline_options = #iree_gpu.pipeline_options<prefetch_shared_memory = true, no_reduce_shared_memory_bank_conflicts = false, use_igemm_convolution = true>, llvm_func_attrs = {"amdgpu-waves-per-eu" = "2"}}>> -> !transform.any_param
    transform.yield %arg0, %0 : !transform.any_op, !transform.any_param
  }

transform.named_sequence @match_generic_112x128x128_320_5760_(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x130x130x640xi8>, %arg2: tensor<320x3x3x640xi8>, %arg3: tensor<112x128x128x320xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1 + d4, d2 + d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d3, d4, d5, d6)>, affine_map<(d0, d1, d2, d3, d4, d5, d6) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%arg1, %arg2 : tensor<112x130x130x640xi8>, tensor<320x3x3x640xi8>) outs(%arg3 : tensor<112x128x128x320xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_112x1280x1024_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x1024x1280xi8>, %arg2: tensor<1280x1280xi8>, %arg3: tensor<112x1280x1024xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x1024x1280xi8>, tensor<1280x1280xi8>) outs(%arg3 : tensor<112x1280x1024xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_458752x5120x640_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<458752x640xi8>, %arg2: tensor<5120x640xi8>, %arg3: tensor<458752x5120xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<458752x640xi8>, tensor<5120x640xi8>) outs(%arg3 : tensor<458752x5120xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_114688x1280x1280_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<114688x1280xi8>, %arg2: tensor<1280x1280xi8>, %arg3: tensor<114688x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<114688x1280xi8>, tensor<1280x1280xi8>) outs(%arg3 : tensor<114688x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_112x20x1024_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<112x1024x1280xi8>, %arg2: tensor<20x64x1280xi8>, %arg3: tensor<112x20x1024x64xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d2, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d1, d3, d4)>, affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2, d3)>], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<112x1024x1280xi8>, tensor<20x64x1280xi8>) outs(%arg3 : tensor<112x20x1024x64xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_114688x1280x5120_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<114688x5120xi8>, %arg2: tensor<1280x5120xi8>, %arg3: tensor<114688x1280xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<114688x5120xi8>, tensor<1280x5120xi8>) outs(%arg3 : tensor<114688x1280xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32): 
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32 
        %4 = arith.muli %2, %3 : i32
...
transform.named_sequence @match_contraction_114688x10240x1280_i8xi8xi32(%arg0: !transform.any_op {transform.readonly}) -> (!transform.any_op, !transform.any_param) {
    %inputs, %outputs = transform.iree.match.cast_compatible_dag_from_root %arg0 {
    ^bb0(%arg1: tensor<114688x1280xi8>, %arg2: tensor<10240x1280xi8>, %arg3: tensor<114688x10240xi32>):
      %1 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"]} ins(%arg1, %arg2 : tensor<114688x1280xi8>, tensor<10240x1280xi8>) outs(%arg3 : tensor<114688x10240xi32>) {
      ^bb0(%in: i8, %in_0: i8, %out: i32):
        %2 = arith.extsi %in : i8 to i32
        %3 = arith.extsi %in_0 : i8 to i32
        %4 = arith.muli %2, %3 : i32
...
//===----------------------------------------------------------------------===//
  ...
  transform.named_sequence @__kernel_config(%arg0: !transform.any_op {transform.consumed}) -> !transform.any_op attributes {iree_codegen.tuning_spec_entrypoint} {
    %updated_root = transform.foreach_match in %arg0
        ...
        // Punet Batch Size 48/56.
        , @match_contraction_112x1024x1920_i8xi8xi32 -> @apply_op_config
        , @match_contraction_112x4096x1920_i8xi8xi32 -> @apply_op_config
        , @match_generic_112x32x32_1280_5760_ -> @apply_op_config
        , @match_contraction_112x1024x2560_i8xi8xi32 -> @apply_op_config
        , @match_contraction_112x16384x960_i8xi8xi32 -> @apply_op_config
        , @match_contraction_112x20x64_i8xi8xi32 -> @apply_op_config
        , @match_generic_112x64x64_640_8640_ -> @apply_op_config
        , @match_contraction_112x16384x640_i8xi8xi32 -> @apply_op_config
        , @match_contraction_112x1280x64_i8xi8xi32 -> @apply_op_config 
        , @match_generic_112x32x32_1280_17280_ -> @apply_op_config
        , @match_generic_112x64x64_640_11520_ -> @apply_op_config
        , @match_contraction_112x640x4096_i8xi8xi32 -> @apply_op_config 
        , @match_contraction_458752x640x2560_i8xi8xi32 -> @apply_op_config 
        , @match_generic_112x64x64_640_17280_ -> @apply_op_config 
        , @match_generic_112x128x128_320_2880_ -> @apply_op_config 
        , @match_contraction_458752x640x640_i8xi8xi32 -> @apply_op_config
        , @match_generic_112x128x128_320_8640_ -> @apply_op_config 
        , @match_generic_112x64x64_640_5760_ -> @apply_op_config 
        , @match_contraction_112x10x4096_i8xi8xi32 -> @apply_op_config 
        , @match_generic_112x128x128_640_5760_ -> @apply_op_config 
        , @match_generic_112x32x32_1280_11520_ -> @apply_op_config 
        , @match_generic_112x32x32_1280_23040_ -> @apply_op_config   
        , @match_generic_112x64x64_1280_11520_ -> @apply_op_config 
        , @match_generic_112x128x128_320_5760_ -> @apply_op_config 
        , @match_contraction_112x1280x1024_i8xi8xi32 -> @apply_op_config 
        , @match_contraction_458752x5120x640_i8xi8xi32 -> @apply_op_config
        , @match_contraction_114688x1280x1280_i8xi8xi32 -> @apply_op_config 
        , @match_contraction_112x20x1024_i8xi8xi32 -> @apply_op_config 
        , @match_contraction_114688x1280x5120_i8xi8xi32 -> @apply_op_config 
        , @match_contraction_114688x10240x1280_i8xi8xi32 -> @apply_op_config 
